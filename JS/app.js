...
function AppViewModel() {
    ...
    this.populateInfoWindow = function(marker, infowindow) {
        if (infowindow.marker != marker) {
            ...
            clientID = "HM5RJ5FA4OZ21BSGA5FUURCSVVPTJLQR5Q1A1VAPEFYOSBFM";
            clientSecret =
                "2TKBLEAPWS31VRLXL2XDMT3WXVEXJPCPG2550GNBPKN1ULOD";
    ...
    this.initMap = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng(32.794176, -96.800649),
            zoom: 15,
            styles: styles
        };
